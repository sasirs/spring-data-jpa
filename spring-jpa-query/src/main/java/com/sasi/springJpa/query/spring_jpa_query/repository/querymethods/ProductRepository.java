...
public interface ProductRepository extends JpaRepository<Product, Long> {
	...
	/**
	 * Returns the found product entry by using its name as search criteria. If no
	 ...
	 * as a method parameters. If no product entries is found, this method returns
	 * an empty list.
	 */
	...
	/**
	 * Return the products whose price is greater than given price as method
	 * parameter
	 * 
	 * @param price
	 * @return
	...
	// Define Native SQL query using @Query annotation with index or position
	// parameters
